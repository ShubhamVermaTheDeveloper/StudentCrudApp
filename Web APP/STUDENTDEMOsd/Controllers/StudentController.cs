...
namespace StudentCrudApp.Controllers
{
    ...
    public class StudentController : Controller
    {
       ...
       public ActionResult Home()
        {
            List<StudentsMOD> StudentData = CreateMethod();  //Initializing a list of studentsMOD object
       ...
       public ActionResult Create()
        ...
        {
            StudentsMOD StudentData = CreateMethod(id);
            if (StudentData == null)
            {
                return NotFound();
            }
        ...
        public List<StudentsMOD> CreateMethod()
        {
